...
function saveHighScore()
{
    ...
    if(initials !== "")
    {
        ...
        localStorage.setItem("highscores", JSON.stringify(highscore)); //setting the highscores array to be written to local storage

        window.location.href = "highscores.html"; //references the new location of the data
    }
}
